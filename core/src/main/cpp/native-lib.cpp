...
Java_com_alexon_core_constants_SecretKeysUtils_baseUrl(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_constants_SecretKeysUtils_googleApiKey(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_constants_SecretKeysUtils_hyperPayApiKey(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_constants_SecretKeysUtils_hyperPayVisaMasterCardEntityId(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_constants_SecretKeysUtils_hyperPayMadaEntityId(JNIEnv *env, jobject thiz) {
