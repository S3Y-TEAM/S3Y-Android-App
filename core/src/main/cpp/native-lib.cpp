...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_keys_SecretKeysUtils_googleApiKey(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_keys_SecretKeysUtils_hyperPayApiKey(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_keys_SecretKeysUtils_hyperPayVisaMasterCardEntityId(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_alexon_core_keys_SecretKeysUtils_hyperPayMadaEntityId(JNIEnv *env, jobject thiz) {
